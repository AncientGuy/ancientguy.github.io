...
The Koan Engine is based on a relatively simple contemplative processing cycle which starts by ... developing large groups of different probing questions in order to *grind the questions against one another* and select the best questions ... contemplate the better questions or sets of better questions deeply, from different perspectives, at different times or in differents modes ... given the benefit of contemplation over time and subconscious reasoning, begin to refactor, possibly simplify or completely change, but develop groups of similar but altered, slightly different more probing questions and then repeat the cycle.

The Koan Engine is not really different ... it merely seeks to find a broader cross-section of different ideas, different questions, on different topics in order to bring more power to bear on the task of grinding and refining the ***essential*** questions ... the POINT of this is deeper, more informed contemplation. 
