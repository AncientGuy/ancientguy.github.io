...
Then ... *since I am damned well aware of the fact that I will get bored with the methods and not think about them OR DO THEM* ... I thought it might be useful to think about the algorithm that would be applied in developing a ***Koan Engine*** ... a randomizer application to remind me to contemplate different methods, in case my senile geezer brain runs into that *deer in the headlights* out-of-ideas problem [*which seems to happen more frequently during fasting or after doing heavy lifting things in the heat...*].  Toward that end, to get me started thinking about this, Gemini was prompted to:
